...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "[HireBest's pricing](/pricing) is public and flat. Basic is $400 per year — a standalone AI screener that runs locally, no cloud required. Advanced is $900 per year and adds multi-user access, custom branding, and bulk uploads of 50+ CVs. Custom Integrated is a $1,500 one-time payment for a full ATS with database storage, role-based dashboards, and API integration. No annual renewal on that last one — ever.",
  ...
  },
  {
    ...
    body: [
      ...
      "## The alternative math",
      "[HireBest's Advanced plan](/pricing) costs $900 per year. It covers unlimited screening, multi-user access, bulk CV uploads, custom branding, and AI scoring with JD-cited reasoning. That is a $6,100 per year difference against [Greenhouse Essential](/vs-greenhouse) — before the renewal hikes kick in.",
    ],
  },
  {
    ...
    body: [
      ...
      "If a hiring manager was previously spending 4 hours screening 50 CVs per role and hiring for 20 roles per year, that is 80 hours of resume reading annually. At a fully-loaded cost of $60/hour, that is $4,800 of management time on a task that takes the AI 8 minutes total. [HireBest Advanced costs $900/year](/pricing). The arithmetic is not complicated.",
    ],
  },
]
